...
func _() {
	...
	_ = x[StateStop-20]
	_ = x[StateFrontLock-21]
}

const _State_name = "DefaultBootBrokenLockedFrontBeginFrontSelectFrontTuneFrontAcceptFrontTimeoutFrontEndServiceBeginServiceAuthServiceMenuServiceInventoryServiceTestServiceRebootServiceNetworkServiceMoneyLoadServiceReportServiceEndStopFrontLock"

var _State_index = [...]uint8{0, 7, 11, 17, 23, 33, 44, 53, 64, 76, 84, 96, 107, 118, 134, 145, 158, 172, 188, 201, 211, 215, 224}
